...
## How to use
1. Download files from [src](src) and place them in the same directory. Launching the script requires **Python 3.9+** and libraries from [requirements.txt](requirements.txt).
